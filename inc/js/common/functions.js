         ...
         // ------------------------------ AFFICHAGE ------------------------
                    ...
                    // ----------------------------------------------------------------------------------
                        ...
                        // ----------------------------------------------------------------------------
                                    ...
                                    var bite = false ;
                                    if ( l_Ocanvas.getContext && bite )
                                    {
                                        g_CANVAS.ctxPion.clearRect( 0, 0, g_CANVAS.w, g_CANVAS.h ) ;
                                        g_CANVAS.ctx.clearRect( 0, 0, g_CANVAS.w, g_CANVAS.h ) ;
                                    }
                                    else
                                    {
                                        $('#index-zone-chess-canvas').html( "" ) ;
                                        var rebuildCanvas = '<canvas id="index-canvas-bg" style="width:1000px; height:300px; position:absolute; top:0px; left:0px"></canvas><canvas id="index-canvas-pion" style="width:1000px; height:300px; position:absolute; top:0px; left:0px">' ;
                                        $('#index-zone-chess-canvas').html( rebuildCanvas ) ;
                                    }
