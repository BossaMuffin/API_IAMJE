        ...
        <div class="row">
          <div class="col-md-12">
            <h2> REPRÉSENTATION GRAPHIQUE </h2>
             <!-- AFFICHAGE ERREURS-->
            <div id="zone-err-php" style="display: none;">
            </div>
            <br/>
             <!-- DATAS RECUES SEQUENCE PROPRE-->
            <div id="zone-sequence-propre" style="display: none;">
            </div>
            <br/>
            <!-- AFFICHAGE DE LA DATA -->
            <div id="zone-data-brute" style="display: none;">
            </div>
            ...
            <br/>
            <br/>
            <form id="index-zone-exec" class="form-horizontal" role="form" method="post" action="#" style="display: none;">
            <!-- SUBMIT EXECUTION -->
              <div class="form-group">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div id="index-zone-chess-canvas">
              <!-- PLATEAU -->
              <canvas id="index-canvas-bg" style="width:1000px; height:300px; position:absolute; top:0px; left:0px">
                

              </canvas>
              <!-- ZONE D'ANIMATION -->
              <canvas id="index-canvas-pion" style="width:1000px; height:300px; position:absolute; top:0px; left:0px">
